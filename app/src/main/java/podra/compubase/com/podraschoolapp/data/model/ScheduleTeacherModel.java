...
public class ScheduleTeacherModel {
    private int class_img,book_img;
    private String clas,book,from,to;

    public ScheduleTeacherModel() {
    }

    public ScheduleTeacherModel(int class_img, int book_img, String clas, String book, String from, String to) {
